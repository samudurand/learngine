...
class TheMovieDBTest {
    ...
    void searchMoviesWithTitleMatrixReturnsResultsWithMissingProperties() {
        ...
        assertEquals(new MovieMetadataSearchResult(1, 63, 4, List.of(
    ...
    MovieMetadataSearchResult matrixMovies() {
        return new MovieMetadataSearchResult(1, 63, 4, List.of(
